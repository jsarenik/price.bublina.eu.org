...
curl -s \
  "https://data-api.cryptocompare.com/index/cc/v1/historical/days?market=sda&instrument=XBX-USD&limit=$limit&aggregate=1&fill=true&apply_mapping=true&response_format=JSON" \
