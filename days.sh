...
curl -s \
  "https://data-api.cryptocompare.com/index/cc/v1/historical/days?market=$marke&instrument=$instr&limit=$limit&aggregate=1&fill=true&apply_mapping=true&response_format=JSON" \
