...
curl "https://data-api.cryptocompare.com/index/cc/v1/historical/days/eod?market=$marke&instrument=$instr&limit=50&aggregate=1&fill=true&apply_mapping=true&response_format=JSON" \
